...
bicubic images.
USAGE EXAMPLE:
python bicubic.py --path ../input/Set14/original ../input/Set5/original --scale-factor 4x
"""
...
parser.add_argument('-s', '--scale-factor', dest='scale_factor', default='4x', 
                    help='make low-res by how much factor', 
                    choices=['2x', '3x', '4x'])
args = vars(parser.parse_args())

paths = args['path']
#print(glob.glob(f"{paths}/*.png"))
images = glob.glob(f"{paths}/*.png")
#for path in paths:
